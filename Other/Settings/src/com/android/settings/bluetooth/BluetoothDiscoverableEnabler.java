...
final class BluetoothDiscoverableEnabler implements Preference.OnPreferenceClickListener {
	...
	//2014-09-25 added by Jacob to fix bug#7035:The detection timeout setting of Bluetooth has wrong
    ...
    private void setEnabled(boolean enable) {
		//2014-09-25 added by Jacob to fix bug#7035:show only visible to paired devices when click bluetooth menu
		mDisplay = false;
        if (enable) {
