...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
	...
	//add by jingliang fixed bug 8731 remove update from sdcard 
	//added by Jacob to fix bug#7295:update from sdcard
	//private static final String KEY_SDCARD_UPDATE_SETTINGS = "sdcard_update_settings";
	private static String SDCARD_UPDATE_ACTION = "android.intent.action.update";
    ...
    public void onCreate(Bundle icicle) {
		...
		//added by Jacob to fix:rm android system update (use fota now)
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
		...
		// add by jingliang fixed bug 8731 remove update from sdcard 
		//else if(preference.getKey().equals(KEY_SDCARD_UPDATE_SETTINGS)){//added by Jacob to fix bug#7295:update from sdcard
		//	Intent updateIntent = new Intent(SDCARD_UPDATE_ACTION);
