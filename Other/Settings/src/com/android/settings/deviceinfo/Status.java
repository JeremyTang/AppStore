...
public class Status extends PreferenceActivity {
    ...
    private void updateServiceState(ServiceState serviceState) {
		...
		//2014-09-28 modified by Jacob to fix bug#7157:Chinese environment settings - about the tablet computer - state information for English network display
        //setSummaryText(KEY_OPERATOR_NAME, serviceState.getOperatorAlphaLong());		
		String netWorkName = mTelephonyManager.getSimOperator();
		String mNetWorkName = serviceState.getOperatorAlphaLong();
		
		if(netWorkName.equals("46000") || netWorkName.equals("46002")|| netWorkName.equals("46007")){
			netWorkName = this.getResources().getString(R.string.china_mobile);
		}
		else if(netWorkName.equals("46001")){
			netWorkName = this.getResources().getString(R.string.china_unicom);
		}
		else if(netWorkName.equals("46003")){
			netWorkName = this.getResources().getString(R.string.china_telecom);
		} 
		else{
		...
		if(mNetWorkName == null){
			 netWorkName = this.getResources().getString(R.string.network_unknown);
		}
		setSummaryText(KEY_OPERATOR_NAME, netWorkName);
        //setSummaryText(KEY_OPERATOR_NAME, serviceState.getOperatorAlphaLong());
    }
