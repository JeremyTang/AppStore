...
//2015-01-08 add by qiuxintai to fix bug#8449:add battery percentage value on statusBar
...
public class PowerUsageSummary extends PreferenceFragment {
    ...
    //2015-01-08 add by qiuxintai to fix bug#8449:add battery percentage value on statusBar
    private static final String KEY_BATTERY_PERCENTAGE = "battery_percentage_toggle";
    private CheckBoxPreference mBatteryPercentageToggle;
    private int mBatteryPercentageSet = 0;
    ...
    public void onCreate(Bundle icicle) {
        ...
        //2015-01-08 add by qiuxintai to fix bug#8449:add battery percentage value on statusBar
        mBatteryPercentageToggle =  (CheckBoxPreference)findPreference(KEY_BATTERY_PERCENTAGE);
    ...
    public void onResume() {
        ...
        //2015-01-08 add by qiuxintai to fix bug#8449:add battery percentage value on statusBar
        mBatteryPercentageSet = Settings.Global.getInt(getActivity().getContentResolver(), "battery_percentage_toggle", 0);
        mBatteryPercentageToggle.setChecked(mBatteryPercentageSet == 1);
        refreshStats();
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        //2015-01-08 add by qiuxintai to fix bug#8449:add battery percentage value on statusBar
        if (mBatteryPercentageToggle == preference) {
            if(mBatteryPercentageToggle.isChecked()){
		Settings.Global.putInt(getActivity().getContentResolver(),"battery_percentage_toggle", 1);
	   }else{
		Settings.Global.putInt(getActivity().getContentResolver(),"battery_percentage_toggle", 0);
	   }
	   Intent mintent = new Intent("battery_percentage_intent");
    ...
    private void refreshStats() {
        ...
        //2015-01-08 add by qiuxintai to fix bug#8449:add battery percentage value on statusBar
        mBatteryPercentageToggle.setOrder(-3);
        mAppListGroup.addPreference(mBatteryPercentageToggle);
