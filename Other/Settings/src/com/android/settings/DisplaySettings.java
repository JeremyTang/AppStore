...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private void updateTimeoutPreferenceDescription(long currentTimeout) {
		...
		//2014-10-21 added by moubiao to add never sleep option on setting begin@{
        ...
        if (currentTimeout < 0) {
            // Unsupported value
			summary = preference.getContext().getString(R.string.screen_timeout_summary, entries[0]);//2014-10-21 added by moubiao to add never sleep option on setting
        } else {
