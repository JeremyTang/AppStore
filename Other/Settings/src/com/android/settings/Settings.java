...
public class Settings extends PreferenceActivity
    ...
    private void updateHeaderList(List<Header> target) {
		//2014-9-28 added by Jacob to fix bug#7161:hidden Developer options and set default adb enable as false
        ...
        while (i < target.size()) {
            ...
            }else if(id == R.id.manufacturer_extra_settings_2){
				target.remove(i);
			}else if(id == R.id.manufacturer_settings){
				target.remove(i);
			}else if(id == R.id.manufacturer_extra_settings_3){
				target.remove(i);
			}
