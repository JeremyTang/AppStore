...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    //2014-10-27 add by qiuxintai to fix bug#7529:select huge font size in DisplaySettings,large text not auto selected in AccessibilitySettings 
    private static final float LARGE_FONT_SCALE = 1.25f;
