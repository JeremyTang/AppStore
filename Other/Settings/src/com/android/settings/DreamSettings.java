...
public class DreamSettings extends SettingsPreferenceFragment {
    ...
    private Dialog createWhenToDreamDialog() {
		// modified by chenfufeng to fix:there is no docked in Daydream.
		boolean isActivatedOnSleep = true;
		CharSequence[] items = null;
		if(isActivatedOnSleep) {
			items = new CharSequence[] { mContext.getString(R.string.screensaver_settings_summary_sleep) };
