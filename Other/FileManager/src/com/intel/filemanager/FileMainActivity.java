...
public class FileMainActivity extends Activity implements TabListener {
    ...
    public String getCurrentPath() {
        ...
        if (FileUtil.getMountedSDCardCount(mActivity) == 1) {
            ...
            } else if (CURRENTPATH.startsWith(pathSDCard) && !FileUtil.isMounted(mActivity, pathSDCard)) {
    ...
    protected BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_MEDIA_MOUNTED)) {
                FileDirFragment mFileDir = (FileDirFragment) mViewPagerAdapter.getItem(TAB_INDEX_DIRECTORY);
                mFileDir.bHas2ndCard = FileUtil.has2ndCard(mActivity);
                mFileDir.initSwitchButton(mFileDir.getView());
                mFileDir.setActionBarTitle(getCurrentPath());
                mFileDir.refreshList();
                ...
                mFileDir.initSwitchButton(mFileDir.getView());
                mFileDir.setActionBarTitle(getCurrentPath());
                mFileDir.CURRENTPATH = Environment.getExternalStorageDirectory().getAbsolutePath();
                mFileDir.refreshList();
