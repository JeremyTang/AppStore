...
public class FileDirFragment extends Fragment implements FileUtil.Defs {
    ...
    public final static String T2_EXTERNAL_PATH = "/mnt/sdcard/sdcard1";
	public final static String USB_STROGE_PATH = "/storage/usbcard1";//add by wuzhaojun to fix bug#3446:Press the return key to quit the file manager
    ...
    public void initSwitchButton(View rootView) {
        ...
        mSwitchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mStepTraceMap.clear();
                if (3 == FileUtil.getMountedSDCardCount(mActivity)) {
                    if (CURRENTPATH != null && CURRENTPATH.startsWith(FileUtil.PATH_SDCARD_3)) {
                        setPath(INITSD);
                        mSwitchButton.setImageResource(R.drawable.main_card_onpressed);
                    }else if (CURRENTPATH != null && CURRENTPATH.startsWith(FileUtil.PATH_SDCARD_2)) {
                        setPath(FileUtil.PATH_SDCARD_3);
                        mSwitchButton.setImageResource(R.drawable.u_disk_onpressed);
                    ...
                    if (CURRENTPATH != null && CURRENTPATH.startsWith(FileUtil.PATH_SDCARD_2)) {
                        setPath(INITSD);
                        mSwitchButton.setImageResource(R.drawable.main_card_onpressed);
                    } else if (CURRENTPATH != null && CURRENTPATH.startsWith(INITSD)) {
                        setPath(FileUtil.PATH_SDCARD_2);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (CURRENTPATH != null && !TextUtils.isEmpty(FileUtil.PATH_SDCARD_3)
                        && CURRENTPATH.startsWith(FileUtil.PATH_SDCARD_3) ){
                    if (CURRENTPATH.equals(FileUtil.PATH_SDCARD_3)) {
                    	//Modified by gezhao 2014/3/4 to fix bug#3522 to distinguish U disk、SD card and internal
                    	if(CURRENTPATH.equals("/storage/usbcard1"))
                    	{
                    		showToast(getString(R.string.u_disk_rootpath));
                    	}
                    	else if(CURRENTPATH.equals("/storage/sdcard1"))
                    	{
                    		showToast(getString(R.string.sd_rootpath));
                    	}
                    	else 
                    		showToast(getString(R.string.external_devices_rootpath));
                        return;
                    }
                    setPath(FileUtil.PATH_SDCARD_3);
                } else if (CURRENTPATH != null && !TextUtils.isEmpty(FileUtil.PATH_SDCARD_2)
                        && CURRENTPATH.startsWith(FileUtil.PATH_SDCARD_2)) {
                    ...
                    if (CURRENTPATH.equals(INITSD)) {
                        showToast(getString(R.string.internal_rootpath));
                        return;
                    }
                    setPath(INITSD);
                }
    ...
    public void setActionBarTitle(CharSequence title) {
        if (!bHas2ndCard
            ...
            if (!TextUtils.isEmpty(CURRENTPATH) && CURRENTPATH.equals(FileUtil.PATH_SDCARD_2)) {
            	if(CURRENTPATH.equals("/storage/usbcard1"))
            	{
            		title = (String) getText(R.string.fm_title_usb);
            	}
            	else if(CURRENTPATH.equals("/storage/sdcard1"))
            	{
            		...
            		title = (String) getText(R.string.fm_title_external_devices);
            } else if (!TextUtils.isEmpty(CURRENTPATH) && CURRENTPATH.equals(PATH_SDCARD_1)) {
                title = (String) getText(R.string.fm_title_internal);
            } else if (!TextUtils.isEmpty(CURRENTPATH) && CURRENTPATH.equals(FileUtil.PATH_SDCARD_3)) {
            	if(CURRENTPATH.equals("/storage/usbcard1"))
            	{
            		title = (String) getText(R.string.fm_title_usb);
            	}
...
//                    mActivity.finish();
//                }
                //Add by gezhao 2014/3/14 to fix bug#3860,3861,3867,3868,3869:add U_disk when use the FileManagerwidget
                if( CURRENTPATH.equals("/storage/usbcard1") || CURRENTPATH.equals("/storage/sdcard1") )
                {
                	if( (!CURRENTPATH.equals(FileUtil.PATH_SDCARD_2)) && (!CURRENTPATH.equals(FileUtil.PATH_SDCARD_3)) )
                    {
                		showToast(R.string.create_shortcut_not_exist);
                		mActivity.finish();
                    }
            ...
            case KeyEvent.KEYCODE_BACK:
                ...
                if ((SHOWMODE == FMAdapter.LISTVIEW)
                    ...
                    return true;
                        ...
                        || CURRENTPATH.equals(USB_STROGE_PATH)) {//add by wuzhaojun to fix bug#3446:Press the return key to quit the file manager
