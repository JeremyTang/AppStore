...
public class FileCategoryFragment extends Fragment {
        ...
        switch (categoryType) {
            case FileUtil.CATEGORY_DOC:
                selection = MediaStore.Files.FileColumns.MIME_TYPE
                        ...
                        +
                        "'application/pdf','application/mspowerpoint')" + " AND (" 
                        + MediaStore.Files.FileColumns.FORMAT + " != 12289)";
                break;
            case FileUtil.CATEGORY_ARC:
    ...
    private void initStoregeView(View rootView) {
        ...
        TextView mExternalPath = (TextView) rootView.findViewById(R.id.tv_external_path);
        if(!TextUtils.isEmpty(path2) && path2.equals("/storage/usbcard1"))
        {
        	mExternalPath.setText(R.string.fm_title_usb);
        }
        else if(!TextUtils.isEmpty(path2) && path2.equals("/storage/sdcard1"))	
        {
        	mExternalPath.setText(R.string.fm_title_external);
        }
        else 
        	mExternalPath.setText(R.string.fm_title_external_devices);
