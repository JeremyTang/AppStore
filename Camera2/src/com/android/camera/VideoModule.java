...
public class VideoModule implements CameraModule,
    ...
    private void generateVideoFilename(int outputFileFormat) {
        ...
        //2014-12-16 add by qiuxintai to modify videos default store directory name.
        //String path = Storage.DIRECTORY + '/' + filename;
        File videos_dir = new File(Storage.DIRECTORY+ "/videos");
        videos_dir.mkdirs();
        String path = Storage.DIRECTORY + "/videos/" + filename;
